...
class Token(object):
    ...
    def __init__(self, name, attr=None):
        """Initialise the name of the token i.e. what lexical token it actually
        corresponds to, and the attribute if any.  For literals and identifies,
        this is the value or the word itself."""
        self._name = name
        self._attr = attr
