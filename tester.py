...
#        CodeGenerator().compile_('class X {static void main(String[] args){'+ wrap_print('!true') + '}}')
        CodeGenerator().compile_(r'\\smbhome.uscs.susx.ac.uk\wjs25\workspace\jaml_compiler\code_generation\code_generation_test\test_files\test_invoke_implemented_method.jml')